 ...
 *   also be "maintenance_page" since theme_preprocess_maintenance_page() calls
 *   this function to have consistent variables.
 */
function theme_preprocess_html(&$variables, $hook) {
	// Add variables and paths needed for HTML5 and responsive support.
	$variables['base_path'] = base_path();
	$variables['directory'] = drupal_get_path('theme', 'theme');
 ...
 */
function theme_process_html(&$variables, $hook) {
 ...
 */
function theme_process_html_tag(&$variables) {
 ...
 */
function theme_html_head_alter(&$head) {
...
function theme_preprocess_maintenance_page(&$variables, $hook) {
	...
	// There's nothing maintenance-related in theme_preprocess_page(). Yet.
 ...
 *   The name of the template being rendered ("maintenance_page" in this case.)
 */
function theme_process_maintenance_page(&$variables, $hook) {
	theme_process_html($variables, $hook);
...
function theme_preprocess_block(&$variables, $hook) {
	...
	// The last_in_region property is set in theme_page_alter().
 ...
 *   The name of the template being rendered ("block" in this case.)
 */
function theme_process_block(&$variables, $hook) {
...
function theme_menu_local_task($variables) {
	...
	// Check for tab type set in theme_menu_local_tasks().
 ...
 */
function theme_preprocess_menu_link(&$variables, $hook) {
 ...
 */
function theme_panels_default_style_render_region($variables) {
